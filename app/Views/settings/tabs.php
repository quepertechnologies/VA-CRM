...
$settings_menu = array(
    ...
    "client_portal" => array(
        ...
        array("name" => "workflows", "url" => "settings/workflows"),
        array("name" => "document_check_lists", "url" => "settings/document_check_lists"),
    ),
...
$settings_menu["setup"][] = array("name" => "locations", "url" => "settings/locations");
