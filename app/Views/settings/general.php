                    ...
                    <div role="tabpanel" class="tab-pane fade" id="general-settings-tab">
                        ...
                        <div class="card-body post-dropzone">
                            <div class="form-group">
                                <div class="row">
                                    <label for="enable_dev_mode" class=" col-md-2"><?php echo app_lang('enable_dev_mode'); ?></label>
                                    <div class="col-md-10">
                                        <?php
                                        echo form_checkbox("enable_dev_mode", "1", is_dev_mode(), "id='enable_dev_mode' class='form-check-input ml15'");
                                        ?>
                                    </div>
                                </div>
                            </div>
