        ...
        <div class="row">
            <div class="col-md-12">
                <div class="page-title clearfix no-border no-border-top-radius no-bg leads-page-title">
                    <h1 class="pl0">
                        <?php echo app_lang('lead_details') . " - " . $lead_info->first_name.' '.$lead_info->last_name ?> 
                    </h1>
                    <div class="title-button-group mr0">
                        ...
                        ?>
                        <a target="_blank" href="<?php echo get_uri('leads/update_lead_to_client/') . $lead_info->id ?>"><button class="btn btn-primary"><i data-feather='briefcase' class='icon-16'></i> <?php echo app_lang('make_client') ?></button></a>
                        <?php //echo modal_anchor(get_uri("leads/update_lead_to_client/") . $lead_info->id, "<i data-feather='briefcase' class='icon-16'></i> " . app_lang('make_client'), array("class" => "btn btn-primary float-end mr15", "title" => app_lang('make_client'))); ?>
                    </div>
                </div>
