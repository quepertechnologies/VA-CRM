<div class="card">
    <div class="table-responsive">
     <table id="leads-cold-table" class="display" cellspacing="0" width="100%">
     </table>
    </div>
</div>
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        $("#leads-cold-table").appTable({
            source: '<?php echo_uri("leads/list_data/3") ?>',
            serverSide: true,
            smartFilterIdentity: "all_cold_leads_list", //a to z and _ only. should be unique to avoid conflicts
