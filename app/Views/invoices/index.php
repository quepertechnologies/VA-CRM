<div id="page-content" class="page-wrapper clearfix grid-button">
    <div class="card clearfix">
        <ul id="invoices-tabs" data-bs-toggle="ajax-tab" class="nav nav-tabs bg-white title" role="tablist">
            ...
            <li><a id="monthly-expenses-button" role="presentation" data-bs-toggle="tab" href="javascript:;" data-bs-target="#monthly-invoices"><?php echo app_lang("general_invoices"); ?></a></li>
            <li><a role="presentation" data-bs-toggle="tab" href="<?php echo_uri("invoices/yearly/"); ?>" data-bs-target="#yearly-invoices"><?php echo app_lang('gross_claim_invoices'); ?></a></li>
            <li><a role="presentation" data-bs-toggle="tab" href="<?php echo_uri("invoices/custom/"); ?>" data-bs-target="#custom-invoices"><?php echo app_lang('net_claim_invoices'); ?></a></li>
...
<script type="text/javascript">
    loadInvoicesTable = function(selector, invoice_type) {
        ...
        $(selector).appTable({
            source: '<?php echo_uri("invoices/list_data") ?>' + '/' + invoice_type,
            // dateRangeType: dateRange,
            serverSide: true,
            smartFilterIdentity: "all_" + invoice_type + "_invoices_list", //a to z and _ only. should be unique to avoid conflicts 
            dateRangeType: "",
            order: [
                [0, "desc"]
            ],
            filterDropdown: [{
                    name: "type",
                    class: "w150",
                    options: <?php echo $types_dropdown; ?>
                },
                {
                    name: "status",
                    class: "w150",
                    options: invoice_statuses_dropdown
                }
    ...
    $(document).ready(function() {
        loadInvoicesTable("#monthly-invoice-table", "general");
        setTimeout(function() {
