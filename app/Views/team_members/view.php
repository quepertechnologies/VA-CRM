...
<div id="page-content" class="clearfix">
    ...
    <ul id="team-member-view-tabs" data-bs-toggle="ajax-tab" class="nav nav-tabs scrollable-tabs rounded-0" role="tablist">
        ...
        <?php if ($show_offices) { ?>
            <li><a  role="presentation" data-bs-toggle="tab" href="<?php echo_uri("team_members/offices/" . $user_info->id); ?>" data-bs-target="#tab-offices"> <?php echo app_lang('offices'); ?></a></li>
        <?php } ?>
    ...
    <div class="tab-content">
        ...
        <div role="tabpanel" class="tab-pane fade" id="tab-offices"></div>
        <?php
        foreach ($hook_tabs as $hook_tab) {
            ?>
