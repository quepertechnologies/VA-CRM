    ...
    <div class="container-fluid">
        ...
        <div class="tab-content mt15">
            ...
            <div role="tabpanel" class="tab-pane" id="account-info-tab">
                ...
                <div class="form-group">
                    <div class="row">
                        <label for="location-id" class="col-md-3"><?php echo app_lang('office_location'); ?></label>
                        <div class="col-md-9">
                            <?php
                            echo form_dropdown("location_id", $location_dropdown, array(), "class='select2' id='location-id'");
                            ?>
                        </div>
                    </div>
                </div>
