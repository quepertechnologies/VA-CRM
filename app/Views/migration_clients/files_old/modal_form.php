<?php echo form_open(get_uri("migration_clients/save_file"), array("id" => "file-form", "class" => "general-form", "role" => "form")); ?>
    ...
    <div class="container-fluid">
        ...
        if ($client_info->account_type) {
            echo view("includes/multi_file_uploader", array(
                "upload_url" => get_uri("migration_clients/upload_file"),
                "validation_url" => get_uri("migration_clients/validate_file"),
