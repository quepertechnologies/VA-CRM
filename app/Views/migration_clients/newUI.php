...
<div class="row">
    <div class="col-md-4"><div class="form-group" id="visa_2_field">
...
<div class="row">
    ...
    <div class="row">
        ...
        <div class="col-md-4"><div class="form-group">
        <label for="secondary_email" class="strong secondary_email_section"><?php echo app_lang('secondary_email'); ?></label>
        <div class="<?php echo $field_column; ?>">
            <?php
            echo form_input(array(
                "id" => "secondary_email",
