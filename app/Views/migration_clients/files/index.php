    ...
    <div class="clearfix grid-button mt-3">
            ...
            <div class="tab-title clearfix no-border">
                <div class="title-button-group">
                    ...
                    if (
                        ...
                        echo modal_anchor(get_uri("migration_clients/checklist_modal_form"), "<i data-feather='plus-circle' class='icon-16'></i> " . app_lang('add_checklist'), array("class" => "btn btn-default", "title" => app_lang('add_checklist'), "data-post-client_id" => $client_id));
                    } elseif (
                        (
                        ...
                        echo modal_anchor(get_uri("migration_clients/file_modal_form"), "<i data-feather='plus-circle' class='icon-16'></i> " . app_lang('add_files'), array("class" => "btn btn-default", "title" => app_lang('add_files'), "data-post-client_id" => $client_id, 'data-post-full_check_list' => '1'));
                    }
                    ?>
                </div>
            </div>
        ...
        <div class="tab-content">
            <div role="tabpanel" class="tab-pane fade" id="check-list">
                <?php echo view("migration_clients/files/check_list"); ?>
            </div>

            <div role="tabpanel" class="tab-pane fade" id="uploaded-files-list">
                <?php echo view("migration_clients/files/uploaded_files_list"); ?>
            </div>
        </div>
    </div>
    <?php if ($page_view) { ?>
