...
<script type="text/javascript">
    loadClientsTable = function(selector) {
        ...
        var quick_filters_dropdown = <?php echo view("migration_clients/quick_filters_dropdown"); ?>;
        ...
        $(selector).appTable({
            source: '<?php echo_uri("migration_clients/list_data") ?>',
            serverSide: true,
            ...
            columns: [{
                ...
                {
                    title: "<?php echo app_lang("visa_phase") ?>",
                    order_by: "visa_phase"
                },
                {
