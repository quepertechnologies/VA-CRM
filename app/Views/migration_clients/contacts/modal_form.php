<?php echo form_open(get_uri("migration_clients/save_contact"), array("id" => "contact-form", "class" => "general-form", "role" => "form", "autocomplete" => "false")); ?>
<div class="modal-body clearfix">
    <?php echo view("migration_clients/contacts/contact_general_info_fields"); ?>
</div>
<div class="modal-footer">
    <div id="link-of-add-contact-modal" class="hide">
        <?php echo modal_anchor(get_uri("migration_clients/add_new_contact_modal_form"), "", array()); ?>
    </div>
