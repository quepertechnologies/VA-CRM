<?php echo form_open(get_uri("migration_clients/save"), array("id" => "client-form", "class" => "general-form", "role" => "form", 'enctype' => 'multipart/form-data')); ?>
<div class="modal-body clearfix">
    <div class="container-fluid">
        <input type="hidden" name="ticket_id" value="<?php echo $ticket_id; ?>" />
        <?php echo view("migration_clients/client_form_fields"); ?>
    </div>
</div>
