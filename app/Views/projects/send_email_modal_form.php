<?php echo form_open(get_uri("projects/send_email"), array("id" => "send-email-form", "class" => "general-form", "role" => "form")); ?>
<div class="modal-body clearfix">
    <div class="container-fluid">
        <input type="hidden" name="id" value="<?php echo $project_info->id; ?>" />
        <input type="hidden" name="milestone_id" value="<?php echo isset($milestone_id) ? $milestone_id : 0; ?>" />
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        window.sendEmailForm = $("#send-email-form").appForm({
            ...
            onSuccess: function(result) {
                if (result.success) {
                    ...
                    window.sendEmailForm.closeModal();
                    setTimeout(() => {
                        location.reload();
                    }, 1500);
                } else {
