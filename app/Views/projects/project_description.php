    ...
    <div class="card-header d-flex justify-content-between align-items-center">
        ...
        <div class="">
            ...
            if ($show_complete_btn) {
                ...
                $options['data-post-project_id'] = $project_info->id;
                echo modal_anchor(get_uri('projects/project_next_stage_modal_form'), '<i data-feather="chevron-right" class="icon-16"></i>Proceed to Next Stage', $options);
            }
            ?>
        </div>
    </div>
    <div class="card-body">
        ...
        <div class="col-sm-12 row mt-4">
            ...
            <div class="col-sm-2">
                ...
                <p><?php echo $project_info->partner_client_id ? $project_info->partner_client_id : '-'; ?></p>
            </div>
