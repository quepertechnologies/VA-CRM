<?php echo form_open(get_uri("settings/save_document_check_list_file"), array("id" => "file-form", "class" => "general-form", "role" => "form")); ?>
<div class="modal-body clearfix">
    <div class="container-fluid">
        ...
        echo view("includes/multi_file_uploader", array(
            ...
            'account_type' => 'admin',
            'description_placeholder' => app_lang('document_check_list_title')
        ));
        ?>
    </div>
</div>
