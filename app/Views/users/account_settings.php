    ...
    <div class="card">
        ...
        <div class="card-body">
            ...
            <?php if ($user_info->user_type === "staff" && ($login_user->is_admin || (!$user_info->is_admin && get_array_value($login_user->permissions, "can_manage_user_role_and_permissions") && $login_user->id !== $user_info->id))) { ?>
                <div class="form-group">
                    <div class="row">
                        <label for="location-id" class=" col-md-2"><?php echo app_lang('office_location'); ?></label>
                        <div class=" col-md-10">
                            <?php
                            echo form_dropdown("location_id", $location_dropdown, array($user_info->location_id), "class='select2' id='location-id'");
                            ?>
                        </div>
                    </div>
                </div>
