    ...
    <div class="container-fluid">
        ...
        <div class="form-group">
            <div class="row">
                ...
                <div class=" col-md-9">
                    <?php
                    echo form_dropdown("id", $contracts_dropdown, array(), "class='select2 validate-hidden' id='contact_id' data-rule-required='true', data-msg-required='" . app_lang('field_required') . "'");
                    ?>
                </div>
            </div>
        </div>
