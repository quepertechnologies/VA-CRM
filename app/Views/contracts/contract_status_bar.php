<div class="col-md-12 mb15">
    <?php
    $full_name =  isset($contract_info->company_name) ? $contract_info->company_name : $contract_info->first_name . ' ' . $contract_info->last_name;
    if ($contract_info->is_lead) {
        echo app_lang("lead") . ": ";
        echo (anchor(get_uri("leads/view/" . $contract_info->client_id), $full_name));
    } else {
        echo app_lang("client") . ": ";
        echo (anchor(get_uri("clients/view/" . $contract_info->client_id), $full_name));
    }
    ?>
</div>
<div class="col-md-12 mb15">
