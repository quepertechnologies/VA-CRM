        ...
        <ul id="attendance-tabs" data-bs-toggle="ajax-tab" class="nav nav-tabs bg-white title" role="tablist">
            ...
            <div class="tab-title clearfix no-border time-card-page-title">
                <div class="title-button-group">
                    <?php echo modal_anchor(get_uri("attendance/modal_form"), "<i data-feather='plus-circle' class='icon-16'></i> " . app_lang('add_checkin'), array("class" => "btn btn-default", "title" => app_lang('add_checkin'))); ?>
                </div>
            </div>
        </ul>
