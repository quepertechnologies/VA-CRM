        ...
        $("#task-table").appTable({
            ...
            filterDropdown: [{
                ...
                },
                {
                    name: "collaborators",
                    class: "w200",
                    options: <?php echo json_encode($collaborators_for_filters_dropdown); ?>
                },
                {
                    name: "priority_id",
                    class: "w200",
            ...
            multiSelect: [{
                ...
                //     class: "w200",
                //     name: "collaborators",
                //     text: "<?php echo app_lang('collaborators'); ?>",
                //     options: <?php echo json_encode($collaborators_for_filters_dropdown); ?>
                // },
            ],
            columns: [{
...
<?php echo view("tasks/update_task_collaborator_script"); ?>