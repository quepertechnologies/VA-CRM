...
foreach ($project_statuses as $status) {
    ...
    if (isset($selected_status_id) && $selected_status_id) {
        ...
        $is_selected = true;
    } else if (isset($selected_status_key) && is_array($selected_status_key)) {
        foreach ($selected_status_key as $selected_status_key_one) {
            if ($selected_status_key_one == $status->key_name) {
                $is_selected = true;
            }
        }
    }
