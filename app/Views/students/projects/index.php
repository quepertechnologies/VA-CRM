    ...
    $(document).ready(function() {
        ...
        $("#project-table").appTable({
            ...
            multiSelect: [{
                ...
                options: <?php echo view("project_status/project_status_dropdown", array("project_statuses" => $project_statuses, "selected_status_key" => is_dev_mode() ? array("open", 'completed', 'hold', 'canceled') : array("open", 'completed', 'hold'))); ?>
            }],
