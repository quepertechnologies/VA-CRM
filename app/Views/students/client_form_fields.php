...
<div class="tab-content mt15">
    ...
    <div <?php if (!isset($is_overview)) {
        ...
        <div class="form-group">
            <div class="row">
                <label for="student-onshore" class="<?php echo $label_column; ?>"><?php echo app_lang('student_onshore'); ?></label>
        ...
        <div class=" form-group hide">
            <div class="row">
                <label for="client_id" class="<?php echo $label_column; ?>"><?php echo app_lang('client_id'); ?></label>
                <div class="<?php echo $field_column; ?>">
                    <?php
        ...
        <div class="form-group">
            <div class="row">
                <label for="phone" class="<?php echo $label_column; ?>">Country Code</label>
                <div class="<?php echo $field_column; ?>">
        ...
        <div class="form-group">
            <div class="row">
                <label for="phone" class="<?php echo $label_column; ?>">Phone #</label>
                <div class="<?php echo $field_column; ?>">
                    <?php
                    echo form_input(array(
                        "id" => "phone",
        ...
        <div class="form-group">
            <div class="row">
                <label for="visa_type" class="<?php echo $label_column; ?>"><?php echo app_lang('visa_type'); ?></label>
                <div class="<?php echo $field_column; ?>">
                    <?php
                    echo form_input(array(
                        "id" => "visa_type",
        ...
        <div class="form-group">
            <div class="row">
                <label for="visa_expiry" class="<?php echo $label_column; ?>"><?php echo app_lang('visa_expiry'); ?></label>
                <div class="<?php echo $field_column; ?>">
                    <?php
                    echo form_input(array(
                        "id" => "visa_expiry",
        ...
        <div class="form-group">
            <div class=" row">
                <label for="counsellor_contact" class="<?php echo $label_column; ?>">Counsellor Phone Code</label>
                <div class=" <?php echo $field_column; ?>">
                    <?php
                    $countries = isset($countries_dropdown) ? $countries_dropdown : '';
                    if (empty($countries)) {
        ...
        <div class="form-group">
            <div class="row">
                <label for="passport_number" class="<?php echo $label_column; ?>"><?php echo app_lang('passport_number'); ?></label>
                <div class="<?php echo $field_column; ?>">
                    <?php
                    echo form_input(array(
                        "id" => "passport_number",
    ...
    <div <?php if (!isset($is_overview)) {
                ...
                <div class="row">
                    ...
                    <div class=" <?php echo $field_column; ?>">
                        ...
                        echo form_datalist(
                            ...
                            $list,
                            'id="funding_source" class="company_name_input_section form-control" placeholder="' . app_lang('funding_source') . '"'
                        );
                        ?>
                ...
                <div class="row">
                    ...
                    <div class=" <?php echo $field_column; ?>">
                        ...
                        echo form_dropdown(
                            ...
                            "id='marriage_status' class='select2 form-control' placeholder='" . app_lang('marital_status') . "'"
                        );
                        ?>
                    </div>
                </div>
                ...
                <div class="row">
                    ...
                    <div class=" <?php echo $field_column; ?>">
                        ...
                        echo form_dropdown(
                            ...
                            "id='timezone' class='select2 form-control' placeholder='" . app_lang('timezone') . "'"
                        );
                        ?>
                    </div>
                </div>
                ...
                <div class="row">
                    ...
                    <div class=" <?php echo $field_column; ?>">
                        ...
                        echo form_dropdown(
                            ...
                            "id='currency' class='select2 form-control' placeholder='" . app_lang('currency') . "'"
                        );
                        ?>
                    </div>
                </div>
        ...
        <div <?php if (!isset($is_overview)) {
            ...
            <!-- <div class="form-group">
                <div class="row">
                    <label for="assignee-manager" class="<?php echo $label_column; ?>"><?php echo app_lang('assignee'); ?></label>
                    <div class="<?php echo $field_column; ?>">
                        <?php
                        echo form_input(array(
            ...
            <div class="form-group">
                <div class="row">
                    <label for="source" class="<?php echo $label_column; ?>"><?php echo app_lang('source'); ?></label>
                    <div class="<?php echo $field_column; ?>">
                        <?php
                        echo form_input(array(
                            "id" => "source",
            ...
            <div class="form-group">
                <div class="row">
                    <label for="tag_name" class="<?php echo $label_column; ?>"><?php echo app_lang('tag_name'); ?></label>
                    <div class="<?php echo $field_column; ?>">
                        <?php
                        echo form_input(array(
                            "id" => "client_labels",
