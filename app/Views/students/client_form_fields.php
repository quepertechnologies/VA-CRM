...
<div class="tab-content mt15">
    ...
    <div <?php if (!isset($is_overview)) {
        ...
        <div class="form-group">
            <div class="row">
                ...
                <div class="<?php echo $field_column; ?> form-check form-switch">
                    <?php
                    if ($model_info->student_onshore == 0) {
                        $set = 0;
                        $bool = false;
                    } else {
                        $set = 1;
            ...
            <div class="row">
                ...
                <div class="<?php echo $field_column; ?>">
                    ...
                    echo form_dropdown(
                        ...
                        $list,
                        isset($model_info->country_of_residence) && !empty($model_info->country_of_residence) ? $model_info->country_of_residence : '',
        ...
        <!-- <div class="form-group">
            <div class="row">
                <label for="visa_phase" class="<?php echo $label_column; ?>"><?php echo app_lang('visa_phase'); ?></label>
                <div class="<?php echo $field_column; ?>">
                    <?php
                    $list = array(
                        '' => '-',
                    ...
                    echo form_dropdown(
                        ...
                        "class='form-control select2' id='visa_phase'"
                    );
                    ?>
                </div>
            </div>
        ...
        <div class="form-group">
            <div class="row">
                <label for="visa_sub_phase" class="<?php echo $label_column; ?>"><?php echo app_lang('visa_sub_phase'); ?></label>
                <div class="<?php echo $field_column; ?>">
                    <?php
                    echo form_datalist(
                        'visa_sub_phase',
                        ...
                        [],
                        "class='form-control' id='visa_sub_phase' placeholder='" . app_lang('visa_sub_phase') . "'"
                    );
                    ?>
                </div>
            </div>
            ...
            <div class="row">
                ...
                <div class="<?php echo $field_column; ?>">
                    ...
                    echo form_datalist(
                        ...
                        $list,
                        'id="funding_source" class="form-control company_name_input_section" placeholder="' . app_lang('funding_source') . '"'
                    );
                    ?>
