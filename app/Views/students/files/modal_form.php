<?php echo form_open(get_uri("students/save_file"), array("id" => "file-form", "class" => "general-form", "role" => "form")); ?>
<div class="modal-body clearfix">
    <div class="container-fluid">
        ...
        $option = array(
            "upload_url" => get_uri("students/upload_file"),
            "validation_url" => get_uri("students/validate_file"),
        );
