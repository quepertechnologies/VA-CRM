<div id="page-content" class="page-wrapper clearfix">
    <div class="clearfix grid-button">
        <ul id="client-tabs" data-bs-toggle="ajax-tab" class="nav nav-tabs bg-white title" role="tablist">
            ...
            <li><a role="presentation" data-bs-toggle="tab" href="<?php echo_uri("students/clients_list/"); ?>" data-bs-target="#clients_list"><?php echo app_lang('students'); ?></a></li>
            <!-- <li><a role="presentation" data-bs-toggle="tab" href="<?php echo_uri("students/contacts/"); ?>" data-bs-target="#contacts"><?php echo app_lang('contacts'); ?></a></li> -->
                ...
                <div class="title-button-group">
                    ...
                    if ($can_edit_clients) {
                        ...
                        if (is_server_localhost()) {
                            echo modal_anchor(get_uri("import/modal_form"), "<i data-feather='upload' class='icon-16'></i> " . app_lang('import_trigger'), array("class" => "btn btn-default", "title" => app_lang('import_trigger')));
                        }
                        ...
                        echo modal_anchor(get_uri("students/modal_form"), "<i data-feather='plus-circle' class='icon-16'></i> " . app_lang('add_student'), array("class" => "btn btn-default", "title" => app_lang('add_student')));
                    }
                    ?>
                </div>
            </div>
        ...
        <div class="tab-content">
            <div role="tabpanel" class="tab-pane fade" id="overview">
                <?php echo view("students/overview/index"); ?>
            </div>
