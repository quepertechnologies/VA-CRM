    ...
    <div class="container-fluid  full-width-button">
        <div class="row clients-view-button">
            <div class="col-md-12">
                ...
                <div>
                    <?php echo view("check_in/info_widgets/index"); ?>
                </div>

                <ul id="client-tabs" data-bs-toggle="ajax-tab" class="nav nav-tabs scrollable-tabs" role="tablist">
                      <li><a  role="presentation" data-bs-toggle="tab" href="<?php echo_uri("check_in/activity/" . $client_info->id); ?>" data-bs-target="#client-activity"> Activity</a></li>
                        <li><a  role="presentation" data-bs-toggle="tab" href="<?php echo_uri("check_in/emails/" . $client_info->id); ?>" data-bs-target="#client-emails">Emails</a></li>
                          <li><a  role="presentation" data-bs-toggle="tab" href="<?php echo_uri("check_in/whatsapp/" . $client_info->id); ?>" data-bs-target="#client-whatsapp">Whatsapp</a></li>


                    <li><a  role="presentation" data-bs-toggle="tab" href="<?php echo_uri("check_in/contacts/" . $client_info->id); ?>" data-bs-target="#client-contacts"> <?php echo app_lang('contacts'); ?></a></li>
                    <li><a  role="presentation" data-bs-toggle="tab" href="<?php echo_uri("check_in/company_info_tab/" . $client_info->id); ?>" data-bs-target="#client-info"> <?php echo app_lang('client_info'); ?></a></li>

                    <?php if ($show_project_info) { ?>
                        <li><a  role="presentation" data-bs-toggle="tab" href="<?php echo_uri("check_in/projects/" . $client_info->id); ?>" data-bs-target="#client-projects"><?php echo app_lang('projects'); ?></a></li>
                    <?php } ?>

                    <li><a  role="presentation" data-bs-toggle="tab" href="<?php echo_uri("check_in/tasks/" . $client_info->id); ?>" data-bs-target="#client-tasks"><?php echo app_lang('tasks'); ?></a></li>

                    <?php if ($show_invoice_info) { ?>
                        <li><a  role="presentation" data-bs-toggle="tab" href="<?php echo_uri("check_in/invoices/" . $client_info->id); ?>" data-bs-target="#client-invoices"> <?php echo app_lang('invoices'); ?></a></li>
                        <li><a  role="presentation" data-bs-toggle="tab" href="<?php echo_uri("check_in/payments/" . $client_info->id); ?>" data-bs-target="#client-payments"> <?php echo app_lang('payments'); ?></a></li>
                    <?php } ?>
                    <?php if ($show_estimate_info) { ?>
                        <!-- <li><a  role="presentation" data-bs-toggle="tab" href="<?php echo_uri("check_in/estimates/" . $client_info->id); ?>" data-bs-target="#client-estimates"> <?php echo app_lang('estimates'); ?></a></li> -->
                    <?php } ?>
                    <?php if ($show_order_info) { ?>
                      <!--   <li><a  role="presentation" data-bs-toggle="tab" href="<?php echo_uri("check_in/orders/" . $client_info->id); ?>" data-bs-target="#client-orders"> <?php echo app_lang('orders'); ?></a></li> -->
                    <?php } ?>
                    <?php if ($show_estimate_request_info) { ?>
                       <!--  <li><a  role="presentation" data-bs-toggle="tab" href="<?php echo_uri("check_in/estimate_requests/" . $client_info->id); ?>" data-bs-target="#client-estimate-requests"> <?php echo app_lang('estimate_requests'); ?></a></li> -->
                    <?php } ?>
                    <?php if ($show_contract_info) { ?>
                        <li><a  role="presentation" data-bs-toggle="tab" href="<?php echo_uri("check_in/contracts/" . $client_info->id); ?>" data-bs-target="#client-contracts"> <?php echo app_lang('contracts'); ?></a></li>
                    <?php } ?>
                    <?php if ($show_proposal_info) { ?>
                        <li><a  role="presentation" data-bs-toggle="tab" href="<?php echo_uri("check_in/proposals/" . $client_info->id); ?>" data-bs-target="#client-proposals"> <?php echo app_lang('proposals'); ?></a></li>
                    <?php } ?>
                    <?php if ($show_ticket_info) { ?>
                        <li><a  role="presentation" data-bs-toggle="tab" href="<?php echo_uri("check_in/tickets/" . $client_info->id); ?>" data-bs-target="#client-tickets"> <?php echo app_lang('tickets'); ?></a></li>
                    <?php } ?>
                    <?php if ($show_note_info) { ?>
                        <li><a  role="presentation" data-bs-toggle="tab" href="<?php echo_uri("check_in/notes/" . $client_info->id); ?>" data-bs-target="#client-notes"> <?php echo app_lang('notes'); ?></a></li>
                    <?php } ?>
                    <li><a  role="presentation" data-bs-toggle="tab" href="<?php echo_uri("check_in/files/" . $client_info->id); ?>" data-bs-target="#client-files"><?php echo app_lang('files'); ?></a></li>

                    <?php if ($show_event_info) { ?>
                        <li><a  role="presentation" data-bs-toggle="tab" href="<?php echo_uri("check_in/events/" . $client_info->id); ?>" data-bs-target="#client-events"> <?php echo app_lang('events'); ?></a></li>
                    <?php } ?>

                    <?php if ($show_expense_info) { ?>
                        <li><a  role="presentation" data-bs-toggle="tab" href="<?php echo_uri("check_in/expenses/" . $client_info->id); ?>" data-bs-target="#client-expenses"> <?php echo app_lang('expenses'); ?></a></li>
                    <?php } ?>
