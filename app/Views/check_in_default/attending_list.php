...
<script type="text/javascript">
    loadCheckInTable = function(selector) {
        ...
        $(selector).appTable({
            ...
            serverSide: true,
            smartFilterIdentity: "checkin_attending_list", //a to z and _ only. should be unique to avoid conflicts
            ...
            columns: [{
                ...
                {
                    title: "<?php echo app_lang("check_in_assignee") ?>"
                },
                {
                    visible: showInvoiceInfo,
                    searchable: showInvoiceInfo,
                    title: "<?php echo app_lang("attend_time") ?>"
                },
    ...
    $(document).ready(function() {
        loadCheckInTable("#checkin-attending-table");
    });
</script>