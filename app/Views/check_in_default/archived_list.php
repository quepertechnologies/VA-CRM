<div class="card">
    <div class="table-responsive">
        <table id="checkin-archived-table" class="display" cellspacing="0" width="100%">
        </table>
    </div>
</div>
...
<script type="text/javascript">
    loadCheckInTable = function(selector) {
        ...
        $(selector).appTable({
            ...
            serverSide: true,
            smartFilterIdentity: "checkin_archived_list", //a to z and _ only. should be unique to avoid conflicts
    ...
    $(document).ready(function() {
        loadCheckInTable("#checkin-archived-table");
    });
</script>