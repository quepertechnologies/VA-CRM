<div class="card">
    <div class="table-responsive">
        <table id="checkin-completed-table" class="display" cellspacing="0" width="100%">
        </table>
    </div>
</div>
...
<script type="text/javascript">
    loadCheckInTable = function(selector) {
        ...
        $(selector).appTable({
            ...
            serverSide: true,
            smartFilterIdentity: "checkin_waiting_list", //a to z and _ only. should be unique to avoid conflicts
            ...
            columns: [{
                ...
                {
                    title: "<?php echo app_lang("session_time") ?>",
                    order_by: "primary_contact"
                },
                {
    ...
    $(document).ready(function() {
        loadCheckInTable("#checkin-completed-table");
    });
</script>