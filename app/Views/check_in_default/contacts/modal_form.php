<?php echo form_open(get_uri("check_in/save_contact"), array("id" => "contact-form", "class" => "general-form", "role" => "form", "autocomplete" => "false")); ?>
<div class="modal-body clearfix">
    <?php echo view("check_in/contacts/contact_general_info_fields"); ?>
</div>
<div class="modal-footer">
    <div id="link-of-add-contact-modal" class="hide">
        <?php echo modal_anchor(get_uri("check_in/add_new_contact_modal_form"), "", array()); ?>
    </div>
