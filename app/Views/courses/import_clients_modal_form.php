<?php echo form_open(get_uri("courses/save_client_from_excel_file"), array("id" => "import-client-form", "class" => "general-form", "role" => "form")); ?>
<div class="modal-body clearfix import-client-modal-body">
    <div class="container-fluid">
        <div id="upload-area">
            <?php
            echo view("includes/multi_file_uploader", array(
                "upload_url" => get_uri("courses/upload_excel_file"),
                "validation_url" => get_uri("courses/validate_import_clients_file"),
                "max_files" => 1,
...
<div class="modal-footer">
    <?php echo anchor("courses/download_sample_excel_file", "<i data-feather='download' class='icon-16'></i> " . app_lang("download_sample_file"), array("title" => app_lang("download_sample_file"), "class" => "btn btn-default float-start")); ?>
