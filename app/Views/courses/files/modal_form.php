<?php echo form_open(get_uri("courses/save_file"), array("id" => "file-form", "class" => "general-form", "role" => "form")); ?>
<div class="modal-body clearfix">
    <div class="container-fluid">
        <input type="hidden" name="client_id" value="<?php echo $client_id; ?>" />
        <?php
        echo view("includes/multi_file_uploader", array(
            "upload_url" => get_uri("courses/upload_file"),
            "validation_url" => get_uri("courses/validate_file"),
        ));
        ?>
    </div>
</div>
