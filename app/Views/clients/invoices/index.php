...
<script type="text/javascript">
    $(document).ready(function() {
        var currencySymbol = "<?php echo $client_info->currency_symbol; ?>",
            isDueAmountVisible = "<?php echo isset($hide_due_amount) && $hide_due_amount ? 1 : 0; ?>" == 1 ? false : true,
            payment_label = "<?php echo app_lang("payment_received") ?>",
            summation = [{
                    column: 8,
                    dataType: 'currency',
        ...
        if (isDueAmountVisible == false) {
            payment_label = "<?php echo app_lang("my_commission") ?>";
            summation = [{
                column: 8,
                dataType: 'currency',
                currencySymbol: currencySymbol
        ...
        console.log('isDueAmountVisible', isDueAmountVisible);
