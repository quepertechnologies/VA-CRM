 ...
 * @return html
 */
if (!function_exists('milestone_activity_logs_widget')) {

    function milestone_activity_logs_widget($params = array(), $milestones = array(), $remaining_check_list_count = 0)
    {
        $ci = new Security_Controller(false);
        $params['limit'] = '10000';
        $limit = get_array_value($params, "limit");
        ...
        $view_data["remaining_check_list_count"] = $remaining_check_list_count;

        echo $view_data["result_remaining"] = view("activity_logs/milestone_activity_logs_widget", $view_data);
    }
}
...
if (!function_exists('total_clients_widget')) {
    ...
    function total_clients_widget($show_own_clients_only_user_id = "", $allowed_client_groups = "", $other_options = array())
    {
        ...
        $title = get_array_value($other_options, 'title');
        if ($title) {
        ...
        $route = get_array_value($other_options, 'route');
        if ($route) {
            return $template->view($route, $view_data);
        } else {
            return $template->view("students/total_clients_widget", $view_data);
        }
    }
}
 ...
 * @return html
 */
if (!function_exists('total_clients_leads')) {
...
if (!function_exists('total_leads')) {
    ...
    function total_leads($show_own_clients_only_user_id = "", $allowed_client_groups = "", $other_options = array())
    {
        ...
        if ($route) {
            ...
            return $template->view("students/total_clients_leads", $view_data);
        }
    }
}
 ...
 * @return html
 */
if (!function_exists('total_clients_prospects')) {
    ...
    function total_clients_prospects($show_own_clients_only_user_id = "", $allowed_client_groups = "", $other_options = array())
    {
        ...
        if ($route) {
            ...
            return $template->view("students/total_clients_prospects", $view_data);
        }
    }
}
...
if (!function_exists('total_contacts_widget')) {
    ...
    {
        $Users_model = model("App\Models\Users_model");
        $view_data["total"] = $Users_model->count_total_contacts(array("show_own_clients_only_user_id" => $show_own_clients_only_user_id, "client_groups" => $allowed_client_groups, 'location_ids' => get_ltm_opl_id(false, ',')));
        $template = new Template();
...
if (!function_exists('total_leads_widget')) {
    ...
    {
        $Clients_model = model("App\Models\Clients_model");
        $view_data["total"] = $Clients_model->count_total_leads(array("show_own_leads_only_user_id" => $show_own_leads_only_user_id, 'location_ids' => get_ltm_opl_id(false, ',')));
...
/**
 * get filters for course overview
 * @param string $widget_type
 * @param boolean $return_as_data
 * @return html
 */
if (!function_exists('course_overview_filter_widget')) {

    function course_overview_filter_widget($widget_type = "", $show_own_clients_only_user_id = "", $allowed_client_groups = "", $return_as_data = false)
    {

        $template = new Template();
        return $template->view("courses/widgets/course_overview_filter_widget", [], $return_as_data);
    }
}

/**
 * get search results widget for course overview
 * @param string $widget_type
 * @param boolean $return_as_data
 * @return html
 */
if (!function_exists('course_overview_course_widget')) {

    function course_overview_course_widget($widget_type = "", $show_own_clients_only_user_id = "", $allowed_client_groups = "", $return_as_data = false)
    {

        $list = array(
            array(
                'title' => 'Foundation in Business',
                'logo' => 'https://app.adventus.io/publicimages/497adcc240d63b6917bccf3082c248fa.png',
                'group' => 'La Trobe University - Sydney Campus via Navitas',
                'location' => 'Australia, Sydney',
                'duration' => '8 months',
                'turnaround' => '0-3 days',
                'price' => 'AUD 27,272 per course',
                'intakes' => 'Mar',
                'is_application_closed' => 0
            ),
            array(
                'title' => 'International Baccalaureate Diploma (Foundation Program)',
                'logo' => 'https://app.adventus.io/publicimages/724be13e288656771c959ba3ac12d5ba.jpeg',
                'group' => 'Palm Beach Currumbin State High via Education Queensland International',
                'location' => 'Australia, Palm Beach',
                'duration' => '1 years',
                'price' => 'AUD 20,754 per year',
                'intakes' => 'Jan',
                'is_application_closed' => 1
            ),
            array(
                'title' => 'Master of Occupational Therapy',
                'logo' => 'https://app.adventus.io/publicimages/90b901a59eb9521983d4893c3e1ff291..png',
                'group' => 'Bond University',
                'location' => 'Australia, Robina',
                'duration' => '2 years',
                'price' => 'AUD 140,640 per course',
                'intakes' => 'May',
                'is_application_closed' => 0
            ),
            array(
                'title' => 'High School program - Junior',
                'logo' => 'https://app.adventus.io/publicimages/14abb7c558f1d5dd76753306407a6f6e..png',
                'group' => 'Jindalee State School via Education Queensland International',
                'location' => 'Australia, Jindalee',
                'duration' => '2 years',
                'price' => 'AUD 16,064 per year',
                'intakes' => 'Jan',
                'is_application_closed' => 1
            ),
            array(
                'title' => 'Master of Project Innovation',
                'logo' => 'https://app.adventus.io/publicimages/90b901a59eb9521983d4893c3e1ff291..png',
                'group' => 'Bond University',
                'location' => 'Australia, Jindalee',
                'duration' => '16 months',
                'price' => 'AUD 57,855 per course',
                'intakes' => 'May',
                'is_application_closed' => 0
            ),
            array(
                'title' => 'High School program - Junior',
                'logo' => 'https://app.adventus.io/publicimages/3d0b38f87b862bcd528a7b1ffdd8f8fd.jpeg',
                'group' => 'Queensland Academy for Health Sciences via Education Queensland International (EQI)',
                'location' => 'Australia, Southport',
                'duration' => '2 years',
                'price' => 'AUD 16,064 per year',
                'intakes' => 'Jan',
                'is_application_closed' => 1
            ...
            array(
                'title' => 'High School program - Senior',
                'logo' => 'https://app.adventus.io/publicimages/3f60e90b812c87fe6ccf387b3a235067.jpeg',
                'group' => 'MacGregor State High School via Education Queensland International',
                'location' => 'Australia, Macgregor',
                'duration' => '2 years',
                'price' => 'AUD 18,160 per year',
                'intakes' => 'Jan',
                'is_application_closed' => 1
            ),
            array(
                'title' => 'Diploma of Business',
                'logo' => 'https://app.adventus.io/publicimages/cbfcfb1090af63df2a880415b0e1d892.png',
                'group' => 'Asia Pacific International College (APIC) via Education Centre of Australia (ECA)',
                'location' => 'Australia, Melbourne',
                'duration' => '1 years',
                'turnaround' => '9+ days',
                'price' => 'AUD 17,600 per year',
                'intakes' => 'Feb',
                'is_application_closed' => 0
            ),
        );
        ...
        $template = new Template();
        return $template->view("courses/widgets/course_overview_course_widget", ['list' => $list], $return_as_data);
    }
}
 ...
 * @return html
 */
if (!function_exists('course_overview_search_results_widget')) {

    function course_overview_search_results_widget($widget_type = "", $show_own_clients_only_user_id = "", $allowed_client_groups = "", $return_as_data = false)
    {

        $template = new Template();
        return $template->view("courses/widgets/course_overview_search_results_widget", [], $return_as_data);
    }
}
 ...
 * @return html
 */
if (!function_exists('Course_overview_title_widget')) {

    function Course_overview_title_widget($widget_type = "", $show_own_clients_only_user_id = "", $allowed_client_groups = "", $return_as_data = false)
    {

        $template = new Template();
        return $template->view("courses/widgets/Course_overview_title_widget", [], $return_as_data);
    }
}
 ...
 * @return html
 */
if (!function_exists('Course_overview_preview_content_widget')) {

    function Course_overview_preview_content_widget($widget_type = "", $show_own_clients_only_user_id = "", $allowed_client_groups = "", $return_as_data = false)
    {

        $template = new Template();
        return $template->view("courses/widgets/Course_overview_preview_content_widget", [], $return_as_data);
    }
}
...
if (!function_exists('team_members_overview_widget')) {
    ...
    function team_members_overview_widget($data = array())
    {
        ...
        $options['location_ids'] = get_ltm_opl_id(false, ',');
        $view_data["total_team_members"] = $ci->Users_model->count_total_users($options);
