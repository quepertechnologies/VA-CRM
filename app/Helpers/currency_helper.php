...
if (!function_exists('to_currency')) {
    ...
    function to_currency($number = 0, $currency = "", $no_of_decimals = 2)
    {
        ...
        if ($decimal_separator === ",") {
            ...
            if ($currency_position === "right") {
                return $negative_sign . number_format((float)$number, $no_of_decimals, ".", $thousand_separator) . $currency;
            } else {
                return $negative_sign . $currency . number_format((float)$number, $no_of_decimals, ".", $thousand_separator);
            }
        }
    }
}
