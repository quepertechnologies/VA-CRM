...
class Migration_clients extends Security_Controller
{
    ...
    function index($tab = "")
    {
        ...
        return $this->template->rander("migration_clients/index", $view_data);
    }
    ...
    function modal_form()
    {
        ...
        return $this->template->view('migration_clients/modal_form', $view_data);
    }
    ...
    function view($client_id = 0, $tab = "")
    {
        ...
        if ($client_id) {
            ...
            if ($client_info && !$client_info->is_lead) {
                ...
                $view_data['nationality'] = $client_info->country_of_citizenship; // for account_type = Student
                ...
                return $this->template->rander("migration_clients/view", $view_data);
            } else {
                show_404();
            }
        } else {
    ...
    function add_remove_star($client_id, $type = "add")
    {
        if ($client_id) {
            ...
            if ($type === "add") {
                ...
                return $this->template->view('migration_clients/star/starred', $view_data);
            } else {
                $this->Clients_model->add_remove_star($client_id, $this->login_user->id, $type = "remove");
                return $this->template->view('migration_clients/star/not_starred', $view_data);
            }
        }
    }
    ...
    function show_my_starred_clients()
    {
        ...
        return $this->template->view('migration_clients/star/clients_list', $view_data);
    }
    ...
    function projects($client_id)
    {
        ...
        return $this->template->view("migration_clients/projects/index", $view_data);
    }
    ...
    function payments($client_id)
    {
        ...
        if ($client_id) {
            ...
            $view_data['client_id'] = clean_data($client_id);
            return $this->template->view("migration_clients/payments/index", $view_data);
        }
    }
    ...
    function tickets($client_id)
    {
        ...
        if ($client_id) {
            ...
            return $this->template->view("migration_clients/tickets/index", $view_data);
        }
    }
    ...
    function invoices($client_id)
    {
        ...
        if ($client_id) {
            ...
            return $this->template->view("migration_clients/invoices/index", $view_data);
        }
    }
    ...
    function estimates($client_id)
    {
        ...
        if ($client_id) {
            ...
            return $this->template->view("migration_clients/estimates/estimates", $view_data);
        }
    }
    ...
    function orders($client_id)
    {
        ...
        if ($client_id) {
            ...
            return $this->template->view("migration_clients/orders/orders", $view_data);
        }
    }
    ...
    function estimate_requests($client_id)
    {
        ...
        if ($client_id) {
            $view_data['client_id'] = clean_data($client_id);
            return $this->template->view("migration_clients/estimates/estimate_requests", $view_data);
        }
    }
    ...
    function notes($client_id)
    {
        ...
        if ($client_id) {
            $view_data['client_id'] = clean_data($client_id);
            return $this->template->view("migration_clients/notes/index", $view_data);
        }
    }
    ...
    function files($client_id, $view_type = "")
    {
        ...
        if ($view_type == "page_view") {
            ...
            return $this->template->rander("migration_clients/files/index", $view_data);
        } else {
            return $this->template->view("migration_clients/files/index", $view_data);
        }
    }
    ...
    function _make_checklist_row($data, $client_id = 0)
    {
        ...
        $options = modal_anchor(get_uri("migration_clients/file_modal_form"), "<i data-feather='plus-circle' class='icon-16'></i> ", array("class" => "btn btn-default btn-sm", "title" => app_lang('add_file') . ": " . $data->label, "data-post-client_id" => $client_id, "data-post-doc_check_list_id" => $data->id, "data-post-doc_check_list_item" => $data->label));
    ...
    function checklist_modal_form()
    {
        ...
        return $this->template->view('migration_clients/files/checklist_modal_form', $view_data);
    }
    ...
    function file_modal_form()
    {
        ...
        $view_data['client_info'] = $this->Clients_model->get_one($client_id);
        return $this->template->view('migration_clients/files/modal_form', $view_data);
    }
    ...
    private function _make_file_row($data)
    {
        ...
        $description = "<div class='float-start'>" .
            js_anchor(remove_file_prefix($data->file_name), array('title' => "", "data-toggle" => "app-modal", "data-sidebar" => "0", "data-url" => get_uri("migration_clients/view_file/" . $data->id)));
        ...
        $options = anchor(get_uri("migration_clients/download_file/" . $data->id), "<i data-feather='download-cloud' class='icon-16'></i>", array("title" => app_lang("download")));

        if ($this->login_user->user_type == "staff") {
            $options .= js_anchor("<i data-feather='x' class='icon-16'></i>", array('title' => app_lang('delete_file'), "class" => "delete", "data-id" => $data->id, "data-action-url" => get_uri("migration_clients/delete_file"), "data-action" => "delete-confirmation"));
        }
    ...
    function view_file($file_id = 0)
    {
        ...
        if ($file_info) {
            ...
            return $this->template->view("migration_clients/files/view", $view_data);
        } else {
            show_404();
        }
    }
    ...
    function contact_profile($contact_id = 0, $tab = "")
    {
        ...
        if ($view_data['user_info']->user_type === "client") {
            ...
            return $this->template->rander("migration_clients/contacts/view", $view_data);
        } else {
            show_404();
        }
    }
    ...
    function my_preferences()
    {
        ...
        return $this->template->view("migration_clients/contacts/my_preferences", $view_data);
    }
    ...
    function contacts($client_id = 0)
    {
        ...
        return $this->template->view("migration_clients/contacts/index", $view_data);
    }
    ...
    function activity($client_id = 0)
    {
        ...
        return $this->template->view("migration_clients/activity/index", $view_data);
    }
    ...
    function emails($client_id = 0)
    {
        ...
        return $this->template->view("migration_clients/emails/index", $view_data);
    }
    ...
    function whatsapp($client_id = 0)
    {
        ...
        return $this->template->view("migration_clients/whatsapp/index", $view_data);
    }
    ...
    function add_new_contact_modal_form()
    {
        ...
        return $this->template->view('migration_clients/contacts/modal_form', $view_data);
    }
    ...
    function contact_general_info_tab($contact_id = 0)
    {
        if ($contact_id) {
            ...
            return $this->template->view('migration_clients/contacts/contact_general_info_tab', $view_data);
        }
    }
    ...
    private function _make_contact_row($data, $custom_fields, $hide_primary_contact_label = false)
    {
        ...
        $contact_link = anchor(get_uri("migration_clients/contact_profile/" . $data->id), $full_name . $primary_contact) . $removal_request_pending;
        if ($this->login_user->user_type === "client") {
        ...
        $row_data = array(
            $user_avatar,
            $contact_link,
            anchor(get_uri("migration_clients/view/" . $data->client_id), $full_name),
            $data->job_title,
            $data->email,
        ...
        $row_data[] = js_anchor("<i data-feather='x' class='icon-16'></i>", array('title' => app_lang('delete_contact'), "class" => "delete", "data-id" => "$data->id", "data-action-url" => get_uri("migration_clients/delete_contact"), "data-action" => "delete"));
    ...
    function invitation_modal()
    {
        ...
        $view_data["client_info"] = $this->Clients_model->get_one($client_id);
        return $this->template->view('migration_clients/contacts/invitation_modal', $view_data);
    }
    ...
    function users()
    {
        if ($this->login_user->user_type === "client") {
            ...
            return $this->template->rander("migration_clients/contacts/users", $view_data);
        }
    }
    ...
    function import_clients_modal_form()
    {
        ...
        return $this->template->view("migration_clients/import_clients_modal_form");
    }
    ...
    {
        $view_data["user_info"] = $this->Users_model->get_one($this->login_user->id);
        return $this->template->view("migration_clients/contacts/gdpr", $view_data);
    }
    ...
    function request_my_account_removal()
    {
        if (get_setting("enable_gdpr") && get_setting("clients_can_request_account_removal")) {
            ...
            app_redirect("migration_clients/contact_profile/$user_id/gdpr");
        }
    }
    ...
    function expenses($client_id)
    {
        ...
        if ($client_id) {
            ...
            return $this->template->view("migration_clients/expenses/index", $view_data);
        }
    }
    ...
    function contracts($client_id)
    {
        ...
        if ($client_id) {
            ...
            return $this->template->view("migration_clients/contracts/contracts", $view_data);
        }
    }
    ...
    function clients_list()
    {
        ...
        return $this->template->view("migration_clients/clients_list", $view_data);
    }
    ...
    function proposals($client_id)
    {
        ...
        if ($client_id) {
            ...
            return $this->template->view("migration_clients/proposals/proposals", $view_data);
        }
    }
    ...
    function tasks($client_id)
    {
        ...
        $view_data['client_id'] = clean_data($client_id);
        return $this->template->view("migration_clients/tasks/index", $view_data);
    }
}
