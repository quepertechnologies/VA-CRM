...
class App_Controller extends Controller
{
    ...
    public $Account_types_model;
    public $Project_partners_model;
    public $Project_doc_check_list_model;
    public $Project_fees_model;
    ...
    private function get_models_array()
    {
        return array(
            ...
            'Check_in_model',
            'Account_types_model',
            'Project_partners_model',
            'Project_doc_check_list_model',
            'Project_fees_model',
    ...
    //get currency dropdown list
    protected function _get_timezones_dropdown_select2_data()
    {
        $timezones = array(array("id" => "", "text" => "-"));
        $timezonesList = DateTimeZone::listIdentifiers();
        foreach ($timezonesList as $value) {
            $timezones[] = array("id" => $value, "text" => $value);
        }
        return $timezones;
    }
}
