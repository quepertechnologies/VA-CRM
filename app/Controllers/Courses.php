...
class Courses extends Security_Controller
{
    ...
    function index($tab = "")
    {
        ...
        return $this->template->rander("courses/index", $view_data);
    }
    ...
    function preview($id = null)
    {
        ...
        return $this->template->rander("courses/preview", $view_data);
    }

    function preview_tab_2()
    {
        return $this->template->rander("courses/widgets/PreviewContentTabs/Tab2", []);
    }

    function preview_tab_3()
    {
        return $this->template->rander("courses/widgets/PreviewContentTabs/Tab3", []);
    }

    function preview_tab_4()
    {
        return $this->template->rander("courses/widgets/PreviewContentTabs/Tab4", []);
    }

    function preview_tab_5()
    {
        return $this->template->rander("courses/widgets/PreviewContentTabs/Tab5", []);
    }

    function preview_tab_6()
    {
        return $this->template->rander("courses/widgets/PreviewContentTabs/Tab6", []);
    }

    function preview_tab_7()
    {
        return $this->template->rander("courses/widgets/PreviewContentTabs/Tab7", []);
    }

    function preview_tab_8()
    {
        return $this->template->rander("courses/widgets/PreviewContentTabs/Tab8", []);
    }
    ...
    function modal_form()
    {
        ...
        return $this->template->view('courses/modal_form', $view_data);
    }
    ...
    private function _make_row($data, $custom_fields)
    {
        ...
        $row_data = array(
            $data->id,
            anchor(get_uri("courses/view/" . $data->id), $data->company_name),
        ...
        $row_data[] = modal_anchor(get_uri("courses/modal_form"), "<i data-feather='edit' class='icon-16'></i>", array("class" => "edit", "title" => app_lang('edit_client'), "data-post-id" => $data->id))
            . js_anchor("<i data-feather='x' class='icon-16'></i>", array('title' => app_lang('delete_client'), "class" => "delete", "data-id" => $data->id, "data-action-url" => get_uri("courses/delete"), "data-action" => "delete-confirmation"));
    ...
    function view($client_id = 0, $tab = "")
    {
        ...
        if ($client_id) {
            ...
            if ($client_info && !$client_info->is_lead) {
                ...
                return $this->template->rander("courses/view", $view_data);
            } else {
                show_404();
            }
        } else {
    ...
    function add_remove_star($client_id, $type = "add")
    {
        if ($client_id) {
            ...
            if ($type === "add") {
                ...
                return $this->template->view('courses/star/starred', $view_data);
            } else {
                $this->Clients_model->add_remove_star($client_id, $this->login_user->id, $type = "remove");
                return $this->template->view('courses/star/not_starred', $view_data);
            }
        }
    }
    ...
    function show_my_starred_clients()
    {
        ...
        return $this->template->view('courses/star/clients_list', $view_data);
    }
    ...
    function projects($client_id)
    {
        ...
        return $this->template->view("courses/projects/index", $view_data);
    }
    ...
    function payments($client_id)
    {
        ...
        if ($client_id) {
            ...
            $view_data['client_id'] = clean_data($client_id);
            return $this->template->view("courses/payments/index", $view_data);
        }
    }
    ...
    function tickets($client_id)
    {
        ...
        if ($client_id) {
            ...
            return $this->template->view("courses/tickets/index", $view_data);
        }
    }
    ...
    function invoices($client_id)
    {
        ...
        if ($client_id) {
            ...
            return $this->template->view("courses/invoices/index", $view_data);
        }
    }
    ...
    function estimates($client_id)
    {
        ...
        if ($client_id) {
            ...
            return $this->template->view("courses/estimates/estimates", $view_data);
        }
    }
    ...
    function orders($client_id)
    {
        ...
        if ($client_id) {
            ...
            return $this->template->view("courses/orders/orders", $view_data);
        }
    }
    ...
    function estimate_requests($client_id)
    {
        ...
        if ($client_id) {
            $view_data['client_id'] = clean_data($client_id);
            return $this->template->view("courses/estimates/estimate_requests", $view_data);
        }
    }
    ...
    function notes($client_id)
    {
        ...
        if ($client_id) {
            $view_data['client_id'] = clean_data($client_id);
            return $this->template->view("courses/notes/index", $view_data);
        }
    }
    ...
    function files($client_id, $view_type = "")
    {
        ...
        if ($view_type == "page_view") {
            ...
            return $this->template->rander("courses/files/index", $view_data);
        } else {
            return $this->template->view("courses/files/index", $view_data);
        }
    }
    ...
    function file_modal_form()
    {
        ...
        return $this->template->view('courses/files/modal_form', $view_data);
    }
    ...
    private function _make_file_row($data)
    {
        ...
        $description = "<div class='float-start'>" .
            js_anchor(remove_file_prefix($data->file_name), array('title' => "", "data-toggle" => "app-modal", "data-sidebar" => "0", "data-url" => get_uri("courses/view_file/" . $data->id)));
        ...
        $options = anchor(get_uri("courses/download_file/" . $data->id), "<i data-feather='download-cloud' class='icon-16'></i>", array("title" => app_lang("download")));

        if ($this->login_user->user_type == "staff") {
            $options .= js_anchor("<i data-feather='x' class='icon-16'></i>", array('title' => app_lang('delete_file'), "class" => "delete", "data-id" => $data->id, "data-action-url" => get_uri("courses/delete_file"), "data-action" => "delete-confirmation"));
        }
    ...
    function view_file($file_id = 0)
    {
        ...
        if ($file_info) {
            ...
            return $this->template->view("courses/files/view", $view_data);
        } else {
            show_404();
        }
    }
    ...
    function contact_profile($contact_id = 0, $tab = "")
    {
        ...
        if ($view_data['user_info']->user_type === "client") {
            ...
            return $this->template->rander("courses/contacts/view", $view_data);
        } else {
            show_404();
        }
    }
    ...
    function my_preferences()
    {
        ...
        return $this->template->view("courses/contacts/my_preferences", $view_data);
    }
    ...
    function contacts($client_id = 0)
    {
        ...
        return $this->template->view("courses/contacts/index", $view_data);
    }
    ...
    function activity($client_id = 0)
    {
        ...
        return $this->template->view("courses/activity/index", $view_data);
    }
    ...
    function emails($client_id = 0)
    {
        ...
        return $this->template->view("courses/emails/index", $view_data);
    }
    ...
    function whatsapp($client_id = 0)
    {
        ...
        return $this->template->view("courses/whatsapp/index", $view_data);
    }
    ...
    function add_new_contact_modal_form()
    {
        ...
        return $this->template->view('courses/contacts/modal_form', $view_data);
    }
    ...
    function contact_general_info_tab($contact_id = 0)
    {
        if ($contact_id) {
            ...
            return $this->template->view('courses/contacts/contact_general_info_tab', $view_data);
        }
    }
    ...
    function company_info_tab($client_id = 0)
    {
        if ($client_id) {
            ...
            return $this->template->view('courses/contacts/company_info_tab', $view_data);
        }
    }
    ...
    private function _make_contact_row($data, $custom_fields, $hide_primary_contact_label = false)
    {
        ...
        $contact_link = anchor(get_uri("courses/contact_profile/" . $data->id), $full_name . $primary_contact) . $removal_request_pending;
        if ($this->login_user->user_type === "client") {
        ...
        $row_data = array(
            $user_avatar,
            $contact_link,
            anchor(get_uri("courses/view/" . $data->client_id), $client_info->company_name),
            $data->job_title,
            $data->email,
        ...
        $row_data[] = js_anchor("<i data-feather='x' class='icon-16'></i>", array('title' => app_lang('delete_contact'), "class" => "delete", "data-id" => "$data->id", "data-action-url" => get_uri("courses/delete_contact"), "data-action" => "delete"));
    ...
    function invitation_modal()
    {
        ...
        $view_data["client_info"] = $this->Clients_model->get_one($client_id);
        return $this->template->view('courses/contacts/invitation_modal', $view_data);
    }
    ...
    function users()
    {
        if ($this->login_user->user_type === "client") {
            ...
            return $this->template->rander("courses/contacts/users", $view_data);
        }
    }
    ...
    function import_clients_modal_form()
    {
        ...
        return $this->template->view("courses/import_clients_modal_form");
    }
    ...
    {
        $view_data["user_info"] = $this->Users_model->get_one($this->login_user->id);
        return $this->template->view("courses/contacts/gdpr", $view_data);
    }
    ...
    function request_my_account_removal()
    {
        if (get_setting("enable_gdpr") && get_setting("clients_can_request_account_removal")) {
            ...
            app_redirect("courses/contact_profile/$user_id/gdpr");
        }
    }
    ...
    function expenses($client_id)
    {
        ...
        if ($client_id) {
            ...
            return $this->template->view("courses/expenses/index", $view_data);
        }
    }
    ...
    function contracts($client_id)
    {
        ...
        if ($client_id) {
            ...
            return $this->template->view("courses/contracts/contracts", $view_data);
        }
    }
    ...
    function clients_list()
    {
        ...
        return $this->template->view("courses/clients_list", $view_data);
    }
    ...
    function proposals($client_id)
    {
        ...
        if ($client_id) {
            ...
            return $this->template->view("courses/proposals/proposals", $view_data);
        }
    }
    ...
    function tasks($client_id)
    {
        ...
        $view_data['client_id'] = clean_data($client_id);
        return $this->template->view("courses/tasks/index", $view_data);
    }
}
