...
class Contracts_model extends Crud_model {
    ...
    function get_details($options = array()) {
        ...
        $sql = "SELECT $contracts_table.*, $clients_table.currency, $clients_table.currency_symbol, $clients_table.company_name, $clients_table.first_name, $clients_table.last_name, $clients_table.is_lead, $projects_table.title AS project_title, 
