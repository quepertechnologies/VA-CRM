...
class Project_files_model extends Crud_model
{
    ...
    function __construct()
    {
        ...
        parent::init_activity_log("project_file", "file_name", "project", "project_id", "", 0, 'milestone', 'milestone_id');
    }
    ...
    function get_details($options = array())
    {
        ...
        if ($doc_check_list_item_id) {
            $where .= " AND $project_files_table.doc_check_list_item_id=$doc_check_list_item_id";
        }
