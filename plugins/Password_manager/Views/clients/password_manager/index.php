    ...
    <div class="card clearfix">
        <ul id="password-manager-tabs" data-bs-toggle="ajax-tab" class="nav nav-tabs scrollable-tabs border-top-radius title" role="tablist">
            ...
            $password_manager_tabs = array(
                "general" => "password_manager/general_for_client/" . $client_id,
                "email" => "password_manager/email_for_client/" . $client_id,
                "password_manager_credit_card" => "password_manager/credit_card_for_client/" . $client_id,
                "password_manager_bank_account" => "password_manager/bank_account_for_client/" . $client_id,
                "password_manager_software_license" => "password_manager/software_license_for_client/" . $client_id
            );
