...
if (!function_exists("make_password_manager_tabs_data")) {
    ...
    function make_password_manager_tabs_data($default_password_manager_tabs = array()) {
        ...
        foreach ($final_password_manager_tabs as $key => $value) {
            echo "<li><a role='presentation' data-bs-toggle='tab' href='" . get_uri($value) . "' data-bs-target='#password-manager-$key-tab-for-client'>" . app_lang($key) . "</a></li>";
        }
    }
...
<div class="card clearfix">
    <ul id="password-manager-tabs" data-bs-toggle="ajax-tab" class="nav nav-tabs scrollable-tabs border-top-radius title" role="tablist">
        ...
        $password_manager_tabs = array(
            "general" => "password_manager/general_for_client/" . $client_id . "/client",
            "email" => "password_manager/email_for_client/" . $client_id . "/client",
            "password_manager_credit_card" => "password_manager/credit_card_for_client/" . $client_id . "/client",
            "password_manager_bank_account" => "password_manager/bank_account_for_client/" . $client_id . "/client",
            "password_manager_software_license" => "password_manager/software_license_for_client/" . $client_id . "/client"
        );
    ...
    <div class="tab-content">
        <div role="tabpanel" class="tab-pane fade" id="password-manager-general-tab-for-client"></div>
        <div role="tabpanel" class="tab-pane fade" id="password-manager-email-tab-for-client"></div>
        <div role="tabpanel" class="tab-pane fade" id="password-manager-password_manager_credit_card-tab-for-client"></div>
        <div role="tabpanel" class="tab-pane fade" id="password-manager-password_manager_bank_account-tab-for-client"></div>
        <div role="tabpanel" class="tab-pane fade" id="password-manager-password_manager_software_license-tab-for-client"></div>
    </div>
</div>
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        $(".nav-tabs li").click(function () {
            ...
            //task status
            if (activeField === "#password-manager-general-tab-for-client") {
                ...
                feather.replace();
            } else if (activeField === "#password-manager-email-tab-for-client") {
                ...
                feather.replace();
            } else if (activeField === "#password-manager-password_manager_credit_card-tab-for-client") {
                ...
                feather.replace();
            } else if (activeField === "#password-manager-password_manager_bank_account-tab-for-client") {
                ...
                feather.replace();
            } else if (activeField === "#password-manager-password_manager_software_license-tab-for-client") {
