                ...
                <?php if ($model_info->username) { ?>
                    <div class="col-md-12 mb15 username-section">
                        <div class="row">
                            ...
                            <div class="col-md-10">
                                <pre class="font-14">
                                    <span class="username"><?php echo $model_info->username; ?></span>
                                    <span style="position: inherit; float: right;" class="help" data-container="body" data-bs-toggle="tooltip" data-bs-placement="top" title="<?php echo app_lang('copy') ?>">
                                        <span data-feather="copy" class="icon-14 float-end clickable text-secondary copy-button copy-username hide pe-auto mt-1" data-type=".username"></span>
                                    </span>
                                </pre>
                            </div>
                        </div>
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        $(".url-section, .username-section, .password-section").hover(
                function () {
                    $(this).find('.copy-url, .copy-username, .copy-password').removeClass("hide").show();
                },
                function () {
                    $(this).find('.copy-url, .copy-username, .copy-password').hide();
                }
        );
