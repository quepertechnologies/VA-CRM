...
namespace Auto_Attendance\Models;

use App\Models\Crud_model;

class Auto_Attendance_settings_model extends Crud_model {

    protected $table = null;

    function __construct() {
        $this->table = 'auto_attendance_settings';
    ...
    function get_all_settings() {
        $settings_table = $this->db->prefixTable('auto_attendance_settings');
