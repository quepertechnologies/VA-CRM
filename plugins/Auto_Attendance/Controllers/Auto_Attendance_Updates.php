...
class Auto_Attendance_Updates extends Security_Controller {
    ...
    function index() {
        ...
        echo $this->template->view("Auto_Attendance\Views\updates\index", $view_data);
    }
    ...
    private function _get_support_info() {
        ...
        $item_purchase_code = get_auto_attendance_setting("auto_attendance_item_purchase_code");
